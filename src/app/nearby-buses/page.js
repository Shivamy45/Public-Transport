						...
						.setPopup(
							new mapboxgl.Popup().setHTML(`
								...
								bus.busName
                                    ...
                                    <small>Distance: ${stop.distance.toFixed(
										2
									)} km</small><br/>
                                    <small>Time: ${
										stop.stopTime || "N/A"
					...
					<div>
						...
						{userLocation ? (
							<div className="text-sm text-gray-600">
								...
								<p className="text-xs">
									Accuracy: ~
									{Math.round(userLocation.accuracy || 0)}{" "}
									meters
								</p>
							</div>
						) : (
			...
			{!userLocation ? (
				<div className="text-center py-12">
					...
					<p className="mt-1 text-sm text-gray-500">
						Click "Get Location" to find buses near you
					</p>
				</div>
			) : (
								...
								<div className="flex justify-between items-center">
									<div>
										...
										<p className="text-sm text-gray-600">
											Your location and nearby bus stops
										</p>
									</div>
							...
							<div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
								...
								<div className="bg-white p-4 rounded-lg border text-center">
									<div className="text-2xl font-bold text-purple-600">
										{nearbyBuses.length > 0
											? nearbyBuses[0].minDistance.toFixed(
													1
											  )
											: "0"}
										km
			...
			<div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
				...
				<div className="grid md:grid-cols-3 gap-4 text-sm text-blue-800">
					<div className="flex items-start gap-2">
						...
						<div>
							<strong>Share Location:</strong> Click "Get
							Location" to allow access to your current position
						</div>
					</div>
					<div className="flex items-start gap-2">
						<span className="flex-shrink-0 w-6 h-6 bg-blue-200 text-blue-800 rounded-full flex items-center justify-center text-xs font-bold">
						...
						<div>
							<strong>Set Radius:</strong> Choose how far you're
					...
					<div className="flex items-start gap-2">
						...
						<div>
							<strong>Find Buses:</strong> See all buses with
							stops within your chosen distance
						</div>
					</div>
				</div>
			</div>
